...
/**
 *
 	Check either the addition or multiplication of two numbers for overflow
 *
**/
...
/**
 *
 	Part of defrag. Create a new header that is the size of two adjacent, free
 	headers. And add this to the linked list.
 *
**/
